...
function SetFinishButtonReady() {
    $("#Finish_button").each(function () {
        this.style.backgroundColor = ReadyColor;
    });
}

function SetFinishButtonWaiting() {
    $("*#Finish_button").each(function () {
...
function SetFinishButtonAssessment() {
    $("*#Finish_button").each(function () {
        this.style.backgroundColor = RunningColor; //ReadyColor;

        // STEPTOE EDIT 04_14_17 BEGIN
        // this.value = "End Game";
        this.value = "Exit Game";
        $('#left-sidebar').css('visibility','hidden');
        $("#idGoodJob").css('visibility','hidden');
        // STEPTOE EDIT 04_14_17 END
