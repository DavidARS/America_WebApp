...
function getState() {
    ...
    if (temp !== null) {
        ...
        // 7.1.2020 Quay
        // Fixing issue of space in state name, browser replaces it with %20'
        ourState = ourState.replace("%20", " "); 
    }
    //console.log("State = " + ourState);

    // 7.1.2020  Quay
    // Why was there a call to getStateInt()? the return value is not assigned and nothing in the fucntion saves this
    // I deleted this here
...
// 6.23.20 Quay
// Added Indiana to Texas
var States = ["Florida", "Idaho", "Illinois", "Minnesota", "Wyoming", "Arizona", "Colorado", "Nevada", "California", "Utah", "New Mexico",
    "Alabama", "Kansas", "Tennessee", "Virginia", "Louisiana", "Michigan", "Mississippi", "Nebraska", "Indiana", "Maryland", "Missouri",
    "North Carolina", "New Jersey", "New York", "Oklahoma", "South Carolina", "Texas"];
// 6.23.20 Quay
