        ...
        success: function ($res) {
            ...
            if (verdata.VERSION) {
                ...
                // Otherwise, use stop words to break url of format a.b.com into short form for footer
                    ...
                    if (useStopWords) {
                        var stopWords = ["quay", "watersim", "dcdc", "apps", "test", "america", "dasampson"];
                        var replaceWord = ["Q", "WS", "DC", "A", "T", "A", "DS"];
...
// END QUAY EDIT
    ...
    // This sets the value of the user control to display the current value of the contraol, Ie where on teh slider or highlight button
    setSlider();
}
