...
function IndicatorControl(divId, anIndicatorType, ControlId, options, showMeterInfo) {
...
//    this.canvas = canvas;
    ...
    // STEPTOE EDIT 05_11_16 BEGIN
    // Controls the placement of the Current/Previous indicator information text
    if(showMeterInfo){
        ...
        // STEPTOE EDIT 02_01_17 BEGIN
        // Added +"px" to Current/Previous indicator information text to place text to right of the last indicator
        this.textCanvas.style.left = (meterDims.width + meterDims.padding.left + this.dims.indicator.x * 2 - 5) + "px";
        // STEPTOE EDIT 02_01_17 END
    }
    // STEPTOE EDIT 05_11_16 BEGIN
...
function DrawIndicator(IndControl) {
    ...
    if(IndControl.UpperTitle && !IndControl.TextDone){
        ...
        if(IndControl.drawOldValue){
            ...
            drawTextAt(IndControl.textCanvas, IndControl.LowerTitle, y, meterDims.height * (2/3));
