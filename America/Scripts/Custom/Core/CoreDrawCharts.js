...
function drawChart(controlID, jsondata) {
    ...
    switch (MainType) {
        ...
        case "PTFOP":
            ...
            drawDoublePieChart(jsondata, controlID, subControls, fldNames, fldValues, CurrentProvider, strtYr, endYr, (strtYr - jsondata.MODELSTATUS.STARTYEAR), fldMINes, fldMAXes, fldLongunits, seriesColors, ChartTypeAreaStacked);
