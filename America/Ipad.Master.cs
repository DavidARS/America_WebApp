...
{
    public partial class IpadMaster : MasterPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CallLoadDynamicLabels(jsonString);
            // *** END MODIFIED QUAY 5/12/15
        }
        ...
        //calling the function for loading Dependent user controls
        ...
        public void LoadUserControl(string keyWord, string jsonString)
        {
                ...
                foreach (dynamic fldInfo in jsonData.FieldInfo)
                {
                    if (fldInfo.FLD.ToString() == keyWord)
                    {
                        ...
                        // MODIFied QUAY 5/7/15
                        string temp = fldInfo.UNT.ToString();
                        userControl.FieldUnit = temp;
                        // End MODIFied QUAY 5/7/15
